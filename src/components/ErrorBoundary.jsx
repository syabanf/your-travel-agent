    ...
    if (this.state.error) {
      ...
      return (
        <div className={inline ? "flex items-center justify-center p-6" : "min-h-screen flex items-center justify-center p-6 bg-[#F3F6FB] font-body"}>
          <div className="bg-white rounded-2xl border border-ich-primary/10 shadow-sm p-8 max-w-md text-center">
            <div className="w-12 h-12 rounded-2xl bg-red-500/10 flex items-center justify-center mx-auto mb-4">
              <AlertTriangle className="w-6 h-6 text-red-600" />
            </div>
            <h1 className="text-xl font-display font-bold text-ich-primary">Something went wrong</h1>
            <p className="text-sm text-ich-neutral mt-1.5">
            ...
            <div className="flex items-center justify-center gap-2 mt-5">
              {inline && (
                <button
                  ...
                  className="rounded-xl px-4 py-2.5 text-sm font-semibold inline-flex items-center gap-2 border border-ich-primary/15 text-ich-primary hover:bg-ich-primary/5 press"
                >
